    ...
    <form method="post" class="form-x" action="uploadtask" enctype="multipart/form-data">  
      ...
      <div class="form-group">
        ...
        <div class="input-append date form_datetime">
          <input class="input w50" value="${taskExpiry}" type="text" style="cursor: text;background-color:white;text-align:center" name="datetime">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <button class="button bg-main icon-check-square-o" type="submit"> 修改提交</button>
        </div>
      </div>
    </form>
  </div>
